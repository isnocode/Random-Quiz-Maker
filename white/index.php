...
<?php if(!$RandomResult && $_SESSION['endPage'] === 'false'){ ?>
   ...
   <div id="StartPage" class="StartPage row m-0 p-0 align-items-center">
      ...
      <form action="index.php" class="col-12 row m-0 p-0 justify-content-center" method="post" >
         <div class="StartBox col-12">
            <h1 class="title">Before you Starting</h1>
            <div class="rules">
...
<?php } if($RandomResult){ ?>   
   ...
   <div id="QuizPage" class="QuizPage row m-0 p-0 align-items-center">
      ...
      <form action="index.php" class="Quiz_form col-12 row p-0 m-0 align-items-center" method="post">
         <?php DisplayScore(); ?>
...
<!-- EndPage -   --   - EndPage -   --   - EndPage -->   
   <div class="EndPage row m-0 p-0 align-items-center">
      ...
      <div class="End_Box col-12">
         <h1>the quiz is finish</h1>
         <h2>your score is <?php echo "$score".' of '."$Number_Of_Questions" ;?></h2>
         <h2>or by percent is <?php percentScore() ;?></h2>
      </div>
